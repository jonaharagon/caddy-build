...
require (
	github.com/caddy-dns/bunny v1.1.2
...
require (
	...
	github.com/digilolnet/bunnynetedgeips v0.0.0-20231129192711-c317e7b8f5ed // indirect
	...
	github.com/libdns/bunny v1.3.1 // indirect
